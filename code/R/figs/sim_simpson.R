...
patient <- rep(LETTERS[1:n_patients], times = n_visits_patient)
visit <- NULL
...
alphas <- rnorm(n_strains, 0, .3)   # transformed to unit normal scale, for the probit
pnorm(alphas) 
