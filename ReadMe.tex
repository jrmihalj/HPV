...
Here we will outline the dynamic, statistical metacommunity model. This model is based off of Dorazio et al. 2010, Ecology, but importantly does not include the estimation of probability of detection.
